...
- 017bc0c: Let a schema declare columns of its own in the config table. A root
...
- 77b31c2: Let a section render its properties as one table.
  ...
  `x-doc.layout` says, that one being the default for a _property's_ children, so
