...
describe('parse-cli-args', () => {
  ...
  it('parses --validators-only boolean flag', () => {
    expect(parseCliArgs(['--validators-only', '--schema', 's.json']).validatorsOnly).toBe(true)
    expect(parseCliArgs(['--validators-only=false', '--schema', 's.json']).validatorsOnly).toBe(false)
  })
  ...
  it('parses --banner with no value as true (default message)', () => {
    expect(parseCliArgs(['--banner'])).toEqual({ banner: true })
  })

  it('parses --banner=true and --banner=false', () => {
    expect(parseCliArgs(['--banner=true'])).toEqual({ banner: true })
    expect(parseCliArgs(['--banner=false'])).toEqual({ banner: false })
  })

  it('parses --banner=<text> as a custom message string', () => {
    expect(parseCliArgs(['--banner=Do not edit this file.'])).toEqual({ banner: 'Do not edit this file.' })
  })

  it('parses --banner <text> (space-separated) as a custom message string', () => {
    expect(parseCliArgs(['--banner', 'Do not edit this file.'])).toEqual({ banner: 'Do not edit this file.' })
  })
