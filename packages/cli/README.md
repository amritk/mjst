...
| `--required-style` | How a property table says which properties are required: `marker` (default — `_required_` beside the name), `column` (a **Required** column), or `split` (a **Required** table, then an **Optional** one). |
