...
- 342c453: Let a schema choose how a property table marks required properties, and make the **Required** column the default.
  ...
  {
    "x-mjst": {
      "markdown": { "table": { "required": "<br><sub><i>required</i></sub>" } }
    }
  }
  ```
...
- f9354c2: Read documentation settings from `x-mjst` instead of `x-doc`.
  ...
  ```json
  {
    "x-mjst": {
      "markdown": {
        "pages": [{ "id": "advanced", "file": "advanced.md" }],
        "table": { "required": "*" }
      }
    },
    "properties": {
      "userId": {
        "type": "string",
        "x-mjst": { "brand": "UserId", "markdown": { "page": "advanced" } }
      },
...
- Updated dependencies [342c453]
- Updated dependencies [2c9b852]
- Updated dependencies [f9354c2]
  - @amritk/generate-markdown@0.11.0
  - @amritk/helpers@0.23.2
  - @amritk/validation@0.3.1
  - @amritk/adapters@0.6.6
  - @amritk/asyncapi@0.3.4
  - @amritk/generate-examples@0.8.8

## 0.24.0

### Minor Changes

- 8751e86: Let a schema drop the **Type:** line from its headings, and keep an enum's values on the page when a type label is hidden.
...
- Updated dependencies [8751e86]
  - @amritk/generate-markdown@0.10.0
...
- Updated dependencies [c1ab994]
  - @amritk/generate-validators@0.18.0
  - @amritk/generate-parsers@0.24.0
  - @amritk/helpers@0.22.0
  - @amritk/adapters@0.6.3
  - @amritk/asyncapi@0.3.1
  - @amritk/generate-examples@0.8.5
...
- 5c4a2e5: Drop `.mjst-manifest.json` and the ownership check it existed for
...
- Updated dependencies [da4af50]
- Updated dependencies [c226e64]
- Updated dependencies [36927c8]
- Updated dependencies [42bc8fe]
  - @amritk/generate-parsers@0.22.0
  - @amritk/generate-validators@0.16.1
...
- Updated dependencies [5364409]
  - @amritk/asyncapi@0.2.0
  - @amritk/helpers@0.20.0
  - @amritk/adapters@0.6.1
  - @amritk/generate-examples@0.8.3
  - @amritk/generate-parsers@0.21.1
  - @amritk/generate-validators@0.16.1
...
- Updated dependencies [3c5d1c9]
- Updated dependencies [c8cb8b0]
- Updated dependencies [7947ca4]
  - @amritk/asyncapi@0.1.0
  - @amritk/adapters@0.6.0
  - @amritk/helpers@0.19.0
  - @amritk/generate-validators@0.16.0
  - @amritk/generate-parsers@0.21.0
  - @amritk/generate-examples@0.8.2
  - @amritk/api@0.16.3
  - @amritk/lint@0.5.3
  - @amritk/resolve-refs@0.7.1
