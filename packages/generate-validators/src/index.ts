...
import { type GeneratedFile, generate, type ImportExtension, type Mode } from '@amritk/validation'
 ...
 *
 * The validator engine moved into `@amritk/validation`, which reaches it — and
