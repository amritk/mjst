...
/**
 * Records a parameter name as an own key.
 *
 ...
 *
 * `@amritk/helpers` carries the same guard, but this package deliberately
 * depends on nothing but `@amritk/runtime-validators` and `@amritk/yaml`.
 */
