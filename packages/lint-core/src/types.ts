import type { DiagnosticSeverity, ILocation, IRange, JsonPath } from '@amritk/lint-parsers'

import type { Document } from './document'

export type { ILocation, IPosition, IRange, JsonPath } from '@amritk/lint-parsers'
export { DiagnosticSeverity } from '@amritk/lint-parsers'
