...
import { resolveSourceOrigin, resolveSourceOriginFromMap, resolveSourcePath } from '../src/pointers'
import type { IDocumentRegistry, IOriginMap, ISourceDocument, JsonPath } from '../src/types'
