...
export const routeFactory = <Context>() => {
  ...
  >(
    route: RouteContract<Params, Query, Body, Headers, Cookies, Responses, Context, Messages>,
  ): RouteContract<Params, Query, Body, Headers, Cookies, Responses, Context, Messages> => route
}
