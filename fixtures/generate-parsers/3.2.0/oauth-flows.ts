...
import { type DeviceAuthorizationObject, parseDeviceAuthorizationObject } from './device-authorization';
...
export const parseOauthFlowsObject = (input: unknown): OauthFlowsObject => {
  ...
  const _deviceAuthorization = input.deviceAuthorization;
  return {
    ...input,
    ...
    ...(_deviceAuthorization !== undefined && { deviceAuthorization: parseDeviceAuthorizationObject(_deviceAuthorization) }),
