import { type ApiKeySecuritySchemeObject, parseApiKeySecuritySchemeObject } from './api-key-security-scheme';
import { type HttpSecuritySchemeObject, parseHttpSecuritySchemeObject } from './http-security-scheme';
import { type Oauth2SecuritySchemeObject, parseOauth2SecuritySchemeObject } from './oauth2-security-scheme';
import { type OpenIdConnectSecuritySchemeObject, parseOpenIdConnectSecuritySchemeObject } from './open-id-connect-security-scheme';
...
export const parseSecuritySchemeObject = (input: unknown): SecuritySchemeObject => input as SecuritySchemeObject;