...
export const parseLinkObject = (input: unknown): LinkObject => {
  ...
  return {
    ...
    ...(input.parameters !== undefined && { parameters: isObject(input?.parameters) ? input?.parameters : typeof input?.parameters === "object" && input?.parameters !== null ? input?.parameters : {} }),
