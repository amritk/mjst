import { type CollectionFormatWithMultiObject, parseCollectionFormatWithMultiObject } from './collection-format-with-multi';
...
export const parseFormDataParameterSubSchemaObject = (input: unknown): FormDataParameterSubSchemaObject => {
  if (!isObject(input)) {
    return {} as unknown as FormDataParameterSubSchemaObject;
  }
  const result = {
    ...input,
    ...((value => value === undefined ? {} : { required: value })(typeof input?.required === "boolean" ? input?.required : (input?.required !== undefined ? Boolean(input?.required) : undefined))),
    ...((value => value === undefined ? {} : { in: value })(typeof input?.in === "string" && ["formData"].includes(input?.in as never) ? input?.in : (input?.in !== undefined ? String(input?.in) : undefined))),
    ...
    ...((value => value === undefined ? {} : { allowEmptyValue: value })(typeof input?.allowEmptyValue === "boolean" ? input?.allowEmptyValue : (input?.allowEmptyValue !== undefined ? Boolean(input?.allowEmptyValue) : undefined))),
    ...((value => value === undefined ? {} : { type: value })(typeof input?.type === "string" && ["string","number","boolean","integer","array","file"].includes(input?.type as never) ? input?.type : (input?.type !== undefined ? String(input?.type) : undefined))),
    ...
    ...(input.collectionFormat && { collectionFormat: parseCollectionFormatWithMultiObject(input.collectionFormat) }),
  ...
  } as unknown as FormDataParameterSubSchemaObject;
