...
export type ServerVariableObject = {
  ...
  enum?: string[];
  /** **REQUIRED**. The default value to use for substitution, which SHALL be sent if an alternate value is _not_ supplied. Note this behavior is different than the [Schema Object's](https://spec.openapis.org/oas/v3.1#schema-object) treatment of default values, because in those cases parameter values are optional. If the [`enum`](https://spec.openapis.org/oas/v3.1#serverVariableEnum) is defined, the value MUST exist in the enum's values. */
  default: string;
