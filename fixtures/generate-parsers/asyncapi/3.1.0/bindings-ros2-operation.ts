export type BindingsRos2OperationObject = {
  ...
  node: string;
  qosPolicies?: { deadline?: number; durability?: "transient_local" | "volatile"; history?: "keep_last" | "keep_all" | "unknown"; leaseDuration?: number; lifespan?: number; liveliness?: "automatic" | "manual"; reliability?: "best_effort" | "realiable" };
