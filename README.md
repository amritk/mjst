...
| [`@amritk/mini-native`](./packages/mini-native) | The same runtime with the browser taken out of the core — a native element vocabulary rendered through a pluggable host (Lynx natively, the DOM as a preview target) |
